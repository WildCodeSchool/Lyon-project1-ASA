...
<div class="container-fluid">
    ...
    <section class="white-box-concept icon">
        <div class="row">
            <div class="col-md-3">
                <p class="'imgcontent">
                    <img src="" alt="<p><strong>Feuille</strong><br /> Blabla bla</p>">
                </p>
                <p><strong>Feuille</strong>
                <br>
                Blabla bla
                </p>
            </div>
            <div class="col-md-3">
                <p class="'imgcontent">
                    <img src="" alt="<p><strong>Health</strong><br />Blabla bla</p>">
                </p>
            ...
            <div class="col-md-3">
                <p class="'imgcontent">
                    <img src="" alt="<p><strong>Fusée</strong><br /> Blabla bla</p>">
                </p>
                <p><strong>Fusée</strong>
                <br>
                Blabla bla
                </p>
            </div>
